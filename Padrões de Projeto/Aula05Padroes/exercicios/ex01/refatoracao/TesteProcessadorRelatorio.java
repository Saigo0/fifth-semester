...
public class TesteProcessadorRelatorio {
    ...
    public static void main(String[] args) {
        ...
        List<ex01.ItemVenda> itens = criarItensVenda();
     ...
     */
    private static List<ex01.ItemVenda> criarItensVenda() {
        return Arrays.asList(
            new ex01.ItemVenda("Notebook Dell Inspiron", 2, 2800.00),
            new ex01.ItemVenda("Mouse Sem Fio Logitech", 3, 120.00),
            new ex01.ItemVenda("Teclado Mecanico RGB", 1, 380.00),
            new ex01.ItemVenda("Monitor 24 Polegadas", 2, 950.00),
            new ex01.ItemVenda("Headset Gamer", 1, 250.00)
        );
    }
     ...
     */
    private static void exibirItensVenda(List<ex01.ItemVenda> itens) {
